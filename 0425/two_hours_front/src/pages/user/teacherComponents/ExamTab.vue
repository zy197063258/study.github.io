    ...
    <div>
        ...
        <el-dialog title="编辑考试"
            ...
            <el-form :model="editExamData"
              ...
              <el-form-item label="题库" prop="store">
<!--                    <el-input v-model="editExamData.store"></el-input>-->
                <el-select v-model="editExamData.store" style="width: 100%">
                  <el-option
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            // 选择题库
          getStoreList(){
            this.searchTitle["pageSize"]=9999;
            this.searchTitle["currentPage"]=1;
            ...
            initEditExam(row){
                ...
                this.editExamData.store = Number(row.store);
